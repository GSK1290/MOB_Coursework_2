...
def main():
    ...
    ax1.set_title("Position vs Time (simpath1)")
    ax1.grid(True)
    ...
    plt.savefig("simpath1_comparison_xy_time.png", dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.set_xlabel("X (m)")
    ax.set_ylabel("Y (m)")
    ax.set_title("Trajectory Comparison (simpath1)")
    ax.axis("equal")
    ax.grid(True)
    ax.legend(loc="upper center", bbox_to_anchor=(0.5, 1.12), ncol=3, frameon=False)
    plt.tight_layout()
    plt.savefig("simpath1_comparison_trajectory.png", dpi=300, bbox_inches="tight")
    plt.show()

    print("Saved:")
    print(" - simpath1_comparison_xy_time.png")
    print(" - simpath1_comparison_trajectory.png")
